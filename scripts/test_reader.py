...
def main():
    """Test the SLSTR FRP reader"""
    
    # Product path
    archive = Path("/mnt/ceph/data/WEKEO/SLSTR/FRP/S3A_SL_2_FRP____20250714T144720_20250714T145220_20250714T171235_0299_128_125______MAR_O_NR_003.SEN3")
    ...
    ds = read_SLSTR_FRP(archive, variables=variables)
    
    # Save to NetCDF
    output_file = "slstr_frp_output.nc"
